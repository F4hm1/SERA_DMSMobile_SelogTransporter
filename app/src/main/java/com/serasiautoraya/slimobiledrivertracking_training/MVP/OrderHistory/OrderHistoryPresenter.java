package com.serasiautoraya.slimobiledrivertracking_training.MVP.OrderHistory;
...
import com.serasiautoraya.slimobiledrivertracking_training.MVP.OrderHistory.OrderHistoryDetail.OrderHistoryDetailActivity;
...
import com.serasiautoraya.slimobiledrivertracking_training.MVP.OrderHistory.OrderHistoryDetail.OrderHistoryDetailSendModel;
...
//        getView().changeActivityAction(HelperKey.KEY_INTENT_ORDERCODE, "ORDER_DUMMY", OrderHistoryDetailActivity.class);
    ...
    public void initialOrderHistoryDatePeriod() {
        SimpleDateFormat dateFormatter = new SimpleDateFormat(com.serasiautoraya.slimobiledrivertracking_training.helper.HelperKey.USER_DATE_FORMAT, Locale.getDefault());
