...
public class ChangePasswordPresenter extends TiPresenter<ChangePasswordView>{
    ...
    public void onRequestSubmitted(){
        ...
        mRestConnection.putData(HelperBridge.sModelLoginResponse.getTransactionToken(), HelperUrl.PUT_CHANGE_PASSWORD, mChangePasswordSendModel.getHashMapType(), new RestCallbackInterfaceJSON() {
            @Override
