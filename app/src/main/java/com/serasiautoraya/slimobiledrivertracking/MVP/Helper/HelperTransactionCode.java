...
public class HelperTransactionCode {
    ...
    public static final String SUBMIT_TYPE_ACTUAL_MOBILE = "CCSMT_04";

    public static final String IS_MOBILE = "1";

    public static final String SUBMIT_TYPE_REQUEST_MOBILE = "CCSMT_02";
